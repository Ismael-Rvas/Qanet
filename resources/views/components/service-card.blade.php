<div class="flex flex-col items-start shadow-lg rounded-2xl p-10 transition-transform transform hover:scale-105"
    ...
    <div data-aos="slide-up" data-aos-duration="1000" data-aos-delay="1000"
        class="h-full w-full bg-opacity-75 p-6 rounded-lg backdrop-blur-none hover:backdrop-blur-md cursor-pointer">
